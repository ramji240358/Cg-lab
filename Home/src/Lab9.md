...
Read 2 corner points of the clipping window (left-top and right-bottom) as (wx1,wy1) and (wx2,wy2)

Assign the region codes for 2 endpoints p1 and p2 using following steps:- initialize code with 0000 Set bit 1 if x<wx1 Set bit 2 if x>wx2 Set bit 3 if y<wy2 Set bit 4 if y>wy1
...
Determine the intersecting edge of clipping window as follows:-
...
Conclusion: We learnt to clip lines using Cohen Sutherland algorithm.